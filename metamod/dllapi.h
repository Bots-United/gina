...
extern void mm_PlayerCustomization( edict_t *pEntity, struct customization_s *pCust );
...
typedef void (*FN_PLAYERCUSTOMIZATION) ( edict_t *pEntity, struct customization_s *pCust );
