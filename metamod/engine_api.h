...
extern const char *mm_Cmd_Args( void );
extern const char *mm_Cmd_Argv( int argc );
extern int mm_Cmd_Argc( void );
...
extern void mm_EndSection(const char *pszSectionName);
...
extern edict_t * mm_CreateFakeClient(const char *netname);
...
extern char *mm_GetInfoKeyBuffer(edict_t *e);
...
extern int mm_GetPlayerUserId(edict_t *e );
...
extern int mm_IsDedicatedServer(void);
